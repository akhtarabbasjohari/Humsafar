...
export const MessageList: React.FC<MessageListProps> = ({
  ...
  if (messages.length === 0) {
    return (
      <div className="flex-1 overflow-y-auto w-full min-h-0 flex flex-col justify-center">
        <div className="flex flex-col items-center justify-center px-4 sm:px-6 py-12 max-w-chat mx-auto w-full text-center">
          <div className="w-16 h-16 rounded-2xl bg-white border border-slate-200 flex items-center justify-center p-2 mb-6 shadow-subtle">
            <Image
              src="/logo.png"
              alt="Humsafar Motif"
              width={48}
