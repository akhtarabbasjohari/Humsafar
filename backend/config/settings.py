"""Django settings for Humsafar backend."""
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-humsafar-dev-key-change-in-production-2026",
)
...
# Defaults to SQLite for local development; supports PostgreSQL via environment variables.
DB_ENGINE = os.getenv("DB_ENGINE", "sqlite")
if DB_ENGINE == "postgresql" or os.getenv("DB_NAME"):
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.postgresql",
            "NAME": os.getenv("DB_NAME", "humsafar"),
